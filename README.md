...
按下左上角的 >> 按钮可展开结果筛选栏目，所有结果默认勾选状态![筛选结果.gif](https://github.com/ReZe20/GUI-for-RePKG/blob/master/docs/4.gif)
...
![按下多选框多选.gif](https://github.com/ReZe20/GUI-for-RePKG/blob/master/docs/6.gif)按下多选按钮也可开始多选，多选模式下再次按下此按钮，按下全选与反选按钮自动打开多选模式![多选按钮.gif](https://github.com/ReZe20/GUI-for-RePKG/blob/master/docs/7.gif)

###### 转换壁纸

转换前需在壁纸预览上方设定导出目录，本程序默认设定桌面为输出目录，请勿设置带有空格的目录![导出目录.gif](https://github.com/ReZe20/GUI-for-RePKG/blob/master/docs/8.gif)
...
![实例测速.png](https://github.com/ReZe20/GUI-for-RePKG/blob/master/docs/20.png)由8核心16线程CPU测试所得数据
